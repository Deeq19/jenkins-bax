...
# ------------------
   ...
   Get-ChildItem $SourcePath -Recurse | Where-Object {($_.LastWriteTime -lt (Get-Date).AddDays(-5))} | Remove-Item -WhatIf        
   Write-Output ("Files have been deleted based on LastWritenTime")| Out-File $OutputSummary
